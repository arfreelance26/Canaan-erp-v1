...
export function BillOfSupplyInvoice({
  invoiceNo,
  date,
  billToName,
  billToAddress,
  ...
  return (
    <div className={s.page}>
      <div className={s.a4}>
        ...
        {/* ── TITLE BAR ── */}
        <div className={s.titleBar}>BILL OF SUPPLY</div>

        {/* ── META TABLE ── */}
        <table className={s.metaTable} style={{ borderBottom: "none" }}>
          <tbody>
            <tr>
              <td style={{ width: "22%" }}>
        ...
        {/* ── CONTACT + SIGNATORY ── */}
        {/* Bill of Supply: separate section with margin-top and full border */}
