...
export interface TaxInvoiceProps {
  ...
  grandTotal: string;
  /** Each row is either an HSN/SAC line, a SGST row, a CGST row, or the total */
  ...
  return (
    <div className={s.page}>
      <div className={s.a4}>
        ...
        {/* ── TITLE BAR ── */}
        <div className={s.titleBar}>TAX INVOICE</div>
          ...
          <tbody>
            <tr>
              ...
              <td colSpan={2}>
                ...
                {billToAddress && (
                  <span className={s.valLight}>{billToAddress}</span>
                )}
              </td>
            </tr>
            <tr>
        ...
        <div className={s.amountBar}>
          <div className={s.amountWords}>
            ...
            <div className={s.val} style={{ marginTop: "3px" }}>{amountInWords}</div>
          </div>
        ...
        {/* ── HSN / SAC TAX BREAKDOWN (SGST + CGST) ── */}
        ...
        <div className={s.bankTerms}>
          <div className={s.bankBox}>
            <div className={s.bankRow}>
              ...
              <span className={s.bankVal}>HDFC - 9181 - Shipping</span>
            </div>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>Branch Name:</span>
              <span className={s.bankVal}>TUTICORIN</span>
            </div>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>Account Number:</span>
              <span className={s.bankVal}>50200037439181</span>
            </div>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>IFSC Code:</span>
              <span className={s.bankVal}>HDFC0001104</span>
            </div>
          </div>
        ...
        {/* ── CONTACT + SIGNATORY ── */}
        {/* Tax Invoice: merged with bankTerms (no top border, no margin) */}
        <div className={s.contactSign}>
          <div className={s.contactBox}>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>Contact Person:</span>
              <span className={s.bankVal}>S SUNDER</span>
            </div>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>Email:</span>
              <span className={s.bankVal}>tutfin@canaanglobal.com</span>
            </div>
            <div className={s.bankRow}>
              <span className={s.bankLbl}>Contact:</span>
              <span className={s.bankVal}>9047015423</span>
            </div>
