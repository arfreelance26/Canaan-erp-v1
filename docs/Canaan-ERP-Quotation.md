...
| 9 | **Finance** | EMI tracking, recurring payments, driver/staff compensation, operating-cost calculator |
| 10 | **P&L & Analytics** | Per-trip profit/loss and mileage, P&L summary, dashboards |
...
| 10 | Finance (EMI, recurring payments, compensation, cost calculator) | 20,000 |
| 11 | P&L, Mileage & Analytics dashboards | 20,000 |
| 12 | Reports, PDF exports & automated cloud backup | 12,000 |
| 13 | Desktop (Windows) application packaging | 8,000 |
| 14 | Testing, deployment, data seeding & UAT support | 15,000 |
